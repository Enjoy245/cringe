...
exports.run = (client, message) => {
	...
	.setAuthor('Devrim Bot', csgopng)
	.setDescription(`${kasadancikanlar}`)
	.setFooter(`Kasayı açan (${message.author.username}) | Kasa Fiyatı: 80$ | Kasadan çıkan bütün ürünler sizde kalmaz sadece eğlence için yapılmıştır`)
	.setColor("ff00f0")
...
exports.config = {
name: "csgokasa",
aliases: ['case','csgokasaaçma','csgo-kasa-açma']
};