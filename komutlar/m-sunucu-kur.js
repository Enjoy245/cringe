...
if(!message.member.permissions.has('ADMINISTRATOR')) return message.reply('<a:hayir:699131258378256465> Bu komutu kullanmak için yetkin yetersiz')
...
.setDescription(`${message.author} **Sunucunun** kurulmasını onaylıyor musun? <a:evet:699131398170214501>
